// Ported from Hachimi-Edge/src/editors/sharedTypes.ts
// Removed dependency on backend files

export type HachimiCommand = string;
...
export type IStoryTextSlotUserData = {
    type: Exclude<StoryTextSlotType, typeof StoryTextSlotType.Choice>;
} | {
    type: typeof StoryTextSlotType.Choice;
    gender?: "male" | "female";
};

export const StoryTextSlotType = {
    Name: 0,
    Content: 1,
    Choice: 2,
    ColorText: 3
} as const;
export type StoryTextSlotType = typeof StoryTextSlotType[keyof typeof StoryTextSlotType];